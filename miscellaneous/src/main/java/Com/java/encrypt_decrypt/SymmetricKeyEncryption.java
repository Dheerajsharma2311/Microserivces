...
public class SymmetricKeyEncryption {
    ...
    public static Key loadSymmetricKey(byte[] symmetricKeyBytes) {
        try {
    ...
    public static byte[] encryptSymmetricKey(Key symmetricKey, PublicKey publicKey) {
        try {
    ...
    public static void saveEncryptedKeyToPEM(byte[] encryptedKeyBytes, String filePath) {
        try {
